...
import os
import random
from art import vs, higher_lower_logo as logo
...
def game():
  ...
  while not done:
    ...
    while choiceB == choiceA:
      choiceB = random.choice(data)
    choiceA_followers = choiceA["follower_count"]
    choiceB_followers = choiceB["follower_count"]
    # print(f"{choiceA['name']}")
    ...
    players_choice = input("Who has more followers? Type 'A' or 'B': ")
